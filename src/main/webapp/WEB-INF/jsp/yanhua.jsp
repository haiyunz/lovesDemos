...
<body background-color:#000;>
	<div style="">
	<canvas id="mycanvas"  style="width:1300px;height:550px;"></canvas>
	</div>
	<script>
    ...
    function Firework(sx,sy,tx,ty){
        ...
        this.speed=2;
        this.jiasudu=1.05;
        this.brightness=random(40,60);//烟花的明度
    ...
    Particle.prototype.update=function(index){
        this.guiji.pop();//删除数组的最后一位数,返回最后一位数
        //unshift() 方法可向数组的开头添加一个或更多元素，并返回新的长度。
        this.guiji.unshift([this.x,this.y]);//开头添加元素
        //下面是烟花碎屑的运动
